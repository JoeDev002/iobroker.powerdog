...
gulp.task('rename', function ()  {
    var newname;
    var author = 'Joachim Schmalz';
    var email  = 'joachim.schmalzl67+iob@gmail.com';
    ...
    if (!newname) {
        console.log('Please write the new powerdog name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/powerdog.png')) {
        fs.renameSync(__dirname + '/admin/powerdog.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/powerdog.html')) {
        fs.renameSync(__dirname + '/widgets/powerdog.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/powerdog/js/powerdog.js')) {
        fs.renameSync(__dirname + '/widgets/powerdog/js/powerdog.js', __dirname + '/widgets/powerdog/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/powerdog')) {
        fs.renameSync(__dirname + '/widgets/powerdog',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /powerdog/g,
        ...
        {
            match: /Powerdog/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Powerdog'
        },
        {
            match: /Joachim Schmalz/g,
            replacement: author
        },
        {
            match: /joachim.schmalzl67+iob@gmail.com/g,
            replacement: email
        }
    ];
    var files = [
